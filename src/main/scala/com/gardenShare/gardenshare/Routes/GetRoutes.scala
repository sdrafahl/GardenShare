...
object GetRoutes {
  ...
  implicit def ioTestingRoutes(implicit e: ApplyUserToBecomeSeller[IO], g: GetUserInfo[IO], cs: ContextShift[IO], gs: GetStore[IO], dec: Decoder[Currency]) = new GetRoutes[IO, TestingAndProductionRoutes]{
  ...
  implicit def ioProductionRoutes(implicit e: ApplyUserToBecomeSeller[IO], g: GetUserInfo[IO], cs: ContextShift[IO], gs: GetStore[IO], dec: Decoder[Currency]) = new GetRoutes[IO, OnlyProductionRoutes] {
